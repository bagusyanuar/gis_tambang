        ...
        <div class="card card-outline card-warning">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <p class="mb-0">Data Member</p>
                    <a href="{{ env('PREFIX_URL') }}/admin/member/tambah" class="main-button f14">
            ...
            <div class="card-body">
                <table id="table-data" class="display w-100 table table-bordered">
                    ...
                    <tr>
                        ...
                        <th class="f14" width="17%">Username</th>
                        <th class="f14">Nama</th>
                        <th class="f14" width="15%">No. Telp</th>
                    ...
                    @foreach($data as $v)
                        <tr>
                            ...
                            <td class="f14">{{ $v->user->username }}</td>
                            <td class="f14">{{ $v->name }}</td>
                            <td class="f14">{{ $v->phone }}</td>
                            <td width="10%" class="text-center">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu dropdown-menu-right">
                                        <a href="{{ env('PREFIX_URL') }}/admin/member/{{$v->user->id}}/edit" class="dropdown-item f12">Edit</a>
                                        <a href="{{ env('PREFIX_URL') }}/admin/member/{{$v->user->id}}/password" class="dropdown-item f12">Ganti Password</a>
                                        <a href="#" data-id="{{ $v->user->id }}"
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function destroy(id) {
            AjaxPost(prefix_url+'/admin/member/' + id + '/delete', function () {
